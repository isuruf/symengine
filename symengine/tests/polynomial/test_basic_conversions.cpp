...
TEST_CASE("basic_to_poly UExpr", "[b2poly]")
{
    ...
    poly2 = UExprPoly::from_vec(
        gen, {{Expression(0), Expression(z), Expression(y) + 1}});
    REQUIRE(eq(*poly1, *poly2));
    ...
    poly2 = UExprPoly::from_vec(gen,
                                {{Expression(0), pow(2, Expression(y)) + 3}});
    REQUIRE(eq(*poly1, *poly2));
    ...
    poly1 = from_basic<UExprPoly>(basic, gen);
    poly2 = UExprPoly::from_vec(
        gen, {{Expression(0), pow(2, Expression(hf)), Expression(1)}});
    REQUIRE(eq(*poly1, *poly2));
    ...
    poly1 = from_basic<UExprPoly>(basic, gen);
    poly2 = UExprPoly::from_vec(
        gen, {{Expression(y) * Expression(z), Expression(y) + Expression(z)}});
    REQUIRE(eq(*poly1, *poly2));
    ...
    poly1 = from_basic<UExprPoly>(basic, gen);
    poly2 = UExprPoly::from_vec(
        gen, {{Expression(1), Expression(y) * 2 + 2, Expression(1)}});
    REQUIRE(eq(*poly1, *poly2));
    ...
    gen = pow(x, x);
    poly1 = from_basic<UExprPoly>(basic, gen);
    poly2 = UExprPoly::from_vec(gen, {{Expression(0), Expression(1),
    ...
    poly1 = from_basic<UExprPoly>(basic, gen);
    poly2 = UExprPoly::from_vec(
        gen, {{1 / Expression(x), Expression(0), Expression(1) / 2}});
    REQUIRE(eq(*poly1, *poly2));
    ...
    poly1 = from_basic<UExprPoly>(basic, gen);
    poly2 = UExprPoly::from_vec(
        gen, {{Expression(0), Expression(z), Expression(1) / 4}});
    REQUIRE(eq(*poly1, *poly2));
...
TEST_CASE("basic_to_poly MExpr", "[b2poly]")
{
    ...
    gens = {twopx};
    poly1 = from_basic<MExprPoly>(basic, gens);
    poly2 = MExprPoly::from_dict({twopx},
                                 {{{1}, Expression(add(x, pow(i2, y)))}});
    REQUIRE(eq(*poly1, *poly2));
    ...
    poly2 = MExprPoly::from_dict(
        {pow(x, x), pow(x, y)},
        {{{1, 0}, pow(Expression(x), Expression(z))}, {{2, 1}, Expression(1)}});
    REQUIRE(eq(*poly1, *poly2));
    ...
    poly1 = from_basic<MExprPoly>(basic, gens);
    poly2 = MExprPoly::from_dict(
        {pi, E}, {{{1, 1}, Expression(z) + 1}, {{2, 0}, Expression(1)}});
    REQUIRE(eq(*poly1, *poly2));
}
