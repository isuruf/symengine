...
TEST_CASE("test_univariate_polynomial(): printing", "[printing]")
{
    ...
    p = univariate_polynomial(x, {{0, 1_z}});
    REQUIRE(p->__str__() == "1");
    //std::cout<<p->__str__()<<std::endl;
    p = univariate_polynomial(x, {{1, 1_z}});
    REQUIRE(p->__str__() == "x");
    //std::cout<<p->__str__()<<std::endl;
    p = univariate_polynomial(x, {{0, 1_z}, {1, 2_z}});
    ...
    REQUIRE(p->__str__() == "-x");
    //std::cout<<p->__str__()<<std::endl;
    p = univariate_polynomial(x, {{0, -1_z}, {1, 1_z}});
    REQUIRE(p->__str__() == "x - 1");
    //std::cout<<p->__str__()<<std::endl;
    p = univariate_polynomial(x, {{0, 1_z}, {1, 1_z}, {2, 1_z}});
    REQUIRE(p->__str__() == "x**2 + x + 1");
    //std::cout<<p->__str__()<<std::endl;
    p = univariate_polynomial(x, {{0, 1_z}, {1, -1_z}, {2, 1_z}});
    REQUIRE(p->__str__() == "x**2 - x + 1");
    //std::cout<<p->__str__()<<std::endl;
    p = univariate_polynomial(x, {{0, 1_z}, {1, 2_z}, {2, 1_z}});
    REQUIRE(p->__str__() == "x**2 + 2*x + 1");
    //std::cout<<p->__str__()<<std::endl;
    p = univariate_polynomial(x, {{1, 2_z}, {2, 1_z}});
